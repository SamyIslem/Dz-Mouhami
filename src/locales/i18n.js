...
const resources = {
  fr: {
    translation: {
      ...
      siteweb: "visiter le site web",
      description: "Description",
      ask: "Demander",
      consultation: "une consultation par téléphone au :",
      fillForm: "Remplir ce formulaire",
...
<<<<<<< HEAD
      ...
      duration: "durée",
      typeCompte: "Type du compte",
      choixCompte: "Veuillez choisir le type de votre compte",
      lawyer: "avocat",
      user: "ustilisateur",
      confirmPassword: "Confirmer le mot de passe",
      contactTitle: "Nous sommes là pour vous aider",
      contactText:
        "Bienvenue sur notre page de contact ! Notre équipe est prête à répondre à toutes vos questions et à vous fournir l'assistance nécessaire. N'hésitez pas à nous contacter pour toute demande, nous sommes là pour vous aider.",
      Motif: "Motif",
      Objet: "Objet",
...
>>>>>>> be66143fed2f99a3b442cf99bc3e682425b4d021
  ...
  ar: {
    translation: {
      ...
      description: "وصف",
      ask: "طلب ",
      consultation: " استشارة هاتفية على:",
      fillForm: "املأ هذا النموذج ",
...
<<<<<<< HEAD
      ...
      choixCompte: "الرجاء اختيار نوع حسابك",
      lawyer: "محامي",
      user: "مستخدم",
      confirmPassword: "أكد كلمة المرور",
      contactTitle: "نحن هنا لمساعدتك",
      contactText:
        "مرحبًا بكم في صفحة الاتصال بنا! يسر فريقنا أن يكون بمتناول يديكم للإجابة على جميع استفساراتكم وتقديم المساعدة التي تحتاجونها. لا تترددوا في التواصل معنا، فنحن هنا لمساعدتكم بكل سرور.",
      Motif: "سبب",
      Objet: "موضوع",
