...
const SignUp = () => {
  ...
  const schema = z.object({
    ...
    confirmPassword: z.string().nonempty("Confirm Password is required").min(6, { message: 'Confirm Password must be at least 6 characters long' }),
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const url = selectedOption === 'user' ? 'http://127.0.0.1:3000/create' :'http://127.0.0.1:3000/lawyer_account/create'
      const info = {
        name: data.username,
